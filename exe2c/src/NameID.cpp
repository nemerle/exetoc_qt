...
const char * NameMng::id2name(H_NAMEID id)
{
...
H_NAMEID NameMng::savname(const char * name)
{
    assert(false);
...
H_NAMEID NameMng::LookupName(const char * name)
{
...
void NameMng::Rename(H_NAMEID h, const char * newname)
{

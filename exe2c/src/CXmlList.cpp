...
CXmlList* CXmlList::new_CXmlList(XMLTYPE xmltype, void * p, size_t posfrom)
{//static int
...
void CXmlList::XMLbegin(XMLTYPE xmltype, void * p0, size_t pos)
{
...
XMLTYPE CXmlList::XMLend(XMLTYPE xmltype, size_t pos)
{
...
CXmlList* CXmlList::GetCurWord(size_t curpos, long &posfrom, long &posto)
{
        CXmlList* p = this;
        while (p)
        {
...
#include "CXmlPrt.h"
void CXmlList::prtprtout(const char * str, CXmlOutPro* prt)
{
...
void CXmlList::Display(const char * pstr, I_COLOROUT* iColorOut, XMLTYPE curw_xmltype, void * curw_p)
{

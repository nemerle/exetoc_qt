...
// Operations
	...
	POSITION push_back(ARG_TYPE newElement);
	POSITION AddTail(ARG_TYPE newElement);

	// add another list of elements before head or after tail
	void push_back(CList* pNewList);
...
template<class TYPE, class ARG_TYPE>
 TYPE CList<TYPE, ARG_TYPE>::GetTail() const
    { ASSERT(m_pNodeTail != NULL);
        return m_pNodeTail->data; }
template<class TYPE, class ARG_TYPE>
 POSITION CList<TYPE, ARG_TYPE>::begin() const
...
template<class TYPE, class ARG_TYPE>
POSITION CList<TYPE, ARG_TYPE>::push_back(ARG_TYPE newElement)
{
//	ASSERT_VALID(this);
...
template<class TYPE, class ARG_TYPE>
void CList<TYPE, ARG_TYPE>::push_back(CList* pNewList)
{
	ASSERT_VALID(this);
	...
	while (pos != NULL)
		push_back(pNewList->GetPrev(pos));
}
...
POSITION CList<TYPE, ARG_TYPE>::InsertBefore(POSITION position, ARG_TYPE newElement)
{
	...
	if (position == NULL)
		return push_back(newElement); // insert before nothing -> head of the list
